...
/// <summary>
/// In addition to the CatmulPath function, this script can instantiate sphere prefab at the new points location to form a pipe
/// There are two methods, one is close circle, one is single curve line
/// Choose one of them by commeting out the other one
/// </summary>

public class CatmulPipeWithSphere : MonoBehaviour
{
    ...
    public float amountOfPoints = 5.0f;
    ...
    //Sphere prefab object to construct pipe, note the pipe location is set by the position of children object, the sphere prefab just make visual pipe
    ...
    void Start()
    {
        ...
        foreach (Vector3 temp in newPoints)
        {
            ...
            prefabSphere.transform.position = pos;
    ...
    */
        ...
        // Method 2, use this for one curve line
