...
/// Read the recorded eye focus infomation, and reproduce them in the new scene with a sphere for each eyefocus location.
/// 
/// </summary>
public class ReproduceEyeFocus : MonoBehaviour
{
    ...
    public GameObject eyeFocusHolder;
    ...
    void Start()
    {
        ...
        for (var i = 0; i < eyeFocusList.Count; i++)
        {
            ...
            float p_x = Convert.ToSingle(eyeFocusList[i][name0]);
            float p_y = Convert.ToSingle(eyeFocusList[i][name1]);
            float p_z = Convert.ToSingle(eyeFocusList[i][name2]);
            ...
            markPoint.transform.parent = eyeFocusHolder.transform;
